...
Característica: Pruebas de Validacion de Solicitudes (Bad Request)
  ...
  Esquema del escenario: Validar el endpoint text/validated con varios casos
    ...
    Ejemplos:
      ...
      | textoInvalido                | 15     | 400         | { "mensaje": "Errores de validación", "errores": [ { "campo": "numero", "mensaje": "El número debe estar entre 0 y 10" }, { "campo": "texto", "mensaje": "El texto debe contener entre 1 y 10 caracteres" } ] } |
